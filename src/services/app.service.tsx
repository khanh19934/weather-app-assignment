...
const generateURLByQueryString = (query: string): string => `/forecast/daily?${query}&appid=${process.env.REACT_APP_OPEN_WEATHER_API}&cnt=7&units=metric`
const getWeatherByLocation = ({latitude, longitude}: {latitude: number, longitude: number}): Promise<AxiosResponse<IWeatherResponse>> => {
